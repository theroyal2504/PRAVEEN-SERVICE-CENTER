...
<head>
    ...
    <title>Suppliers - Bike Management System</title>
                                                ...
                                                <form method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="supplier_name" value="<?php echo htmlspecialchars($row['supplier_name']); ?>" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Contact Person</label>
                                                            <input type="text" class="form-control" name="contact_person" value="<?php echo htmlspecialchars($row['contact_person']); ?>">
                                                        </div>
                                                        <div class="mb-3">
